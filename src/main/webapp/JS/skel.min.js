var skel = function() {
    ...
    var t = {
        ...
        extend: function(e, n) {
            t.iterate(n, function(i) {
                t.isArray(n[i])
                    ...
                    : typeof n[i] === "object"
                    ? (typeof e[i] !== "object" && (e[i] = {}), t.extend(e[i], n[i]))
                    : e[i] = n[i];
            });
        },
        newStyle: function(t) {
        ...
        trigger: function(e) {
            return t.events[e] && t.events[e].length !== 0
        ...
        changeState: function(e) {
            ...
            t.stateId = e;
            t.breakpointIds = t.stateId === t.sd
                ? []
                : t.stateId.substring(1).split(t.sd);
        ...
        detach: function(t) {
            var e = t.element;
            return t.permanent || !e.parentNode || e.parentNode && !e.parentNode.tagName
                ? false
                : (e.parentNode.removeChild(e), true);
        },
        ...
        initMethods: function() {
            document.addEventListener
                ...
                : !function(e, n) {
                    ...
                    var n, i = [], a = false, r = document, o = r.documentElement, s = o.doScroll, c = "DOMContentLoaded", d = "addEventListener", u = "onreadystatechange", l = "readyState", f = s ? /^loaded|^c/ : /^loaded|c/, h = f.test(r[l]);
            ...
            Object.keys
                ? t.iterate = function(t, e) {
                    ...
                    for (n = 0; i[n] && e(i[n], t[i[n]]) !== false; n++);
                }
                : t.iterate = function(t, e) {
                    if (!t) return [];
                    var n;
                    for (n in t) if (Object.prototype.hasOwnProperty.call(t, n) && e(n, t[n]) === false) break;
                };

            window.matchMedia
                ? t.matchesMedia = function(t) {
                    return t === "" ? true : window.matchMedia(t).matches;
                }
                : window.styleMedia || window.media
                    ...
                    : window.getComputedStyle
                        ...
                        : t.matchesMedia = function(t) {
                            ...
                            return r["min-width"] !== null && s < r["min-width"] || r["max-width"] !== null && s > r["max-width"] || r["min-height"] !== null && c < r["min-height"] || r["max-height"] !== null && c > r["max-height"] ? false : true;
                        };
        ...
        initVars: function() {
            ...
            t.iterate(i, function(t, i) {
                return a.match(i[1])
                    ? (e = i[0], n = parseFloat(RegExp.$1), false)
                    : void 0;
            });
            ...
            t.iterate(i, function(t, i) {
                return a.match(i[1])
                    ? (e = i[0], n = parseFloat(i[2] ? i[2](RegExp.$1) : RegExp.$1), false)
                    : void 0;
            });

            t.vars.os = e;
            t.vars.osVersion = n;
            t.vars.IEVersion = t.vars.browser === "ie" ? t.vars.browserVersion : 99;
            t.vars.touch = t.vars.os === "wp"
                ? navigator.msMaxTouchPoints > 0
                : !!("ontouchstart" in window);
            t.vars.mobile = t.vars.os === "wp" || t.vars.os === "android" || t.vars.os === "ios" || t.vars.os === "bb";
        }
    };
